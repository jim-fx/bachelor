...
\linebreak
\linebreak
In meinem eigenen Tool \href{https://plant.max-richter.dev}{Plantarium} habe ich eine node-basierte visuelle Programmiersprache implementiert, die es Nutzer*innen ermöglicht, parametrische 3D Pflanzen zu erstellen. 
...
Der Großteil der Arbeit wird in der Implementierung liegen. Ich werde die Anwendung in Typescript und Rust schreiben. Typescript bietet die Möglichkeit typensicheren Code für den Browser zu schreiben und Rust lässt sich gut zu WebAssembly kompilieren. Beides sind sehr etablierte Sprachen mit jeweils einer großen Community.
...
\section{Formales}
Geplantes Startdatum: 13.02.2024
\linebreak
